...
* [x] List anything else that you can get done to improve the app functionality!
  ...
  [x] Unique look achieved by use of new Material Design
  [x] Created bubble animation for the tweet button and the compose text view
  [x] Added a custom button inside the compose text view to delete text
